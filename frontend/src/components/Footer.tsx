        ...
        <div className='flex w-[1440px] mx-auto justify-between items-center h-full'>
            <div className='flex flex-col gap-5 justify-center items-start'>
                ...
                <div className='flex bg-white h-fit w-fit p-1 rounded-md'>
                    <input type="text" className='p-2 h-10 w-52' placeholder='Имэйл хаяг'/>
                    <button className='bg-[#FB2E86] h-10 rounded-lg px-5 text-white'>Бүртгүүлэх</button>
                </div>
                <div className='flex flex-col gap-2 text-[#8A8FB9]'>
                    <p>Хаяг</p>
                    <p>Олимпын гудамж, 1-р хороо, Сүхбаатар дүүрэг, Улаанбаатар хот, <br />Гурван гол - 401 тоот</p>
                </div>
            </div>
