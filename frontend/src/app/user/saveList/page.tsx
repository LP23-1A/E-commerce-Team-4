    ...
    <div>
        ...
        <div className='flex flex-col gap-10 mx-auto w-[1440px] mt-20 mb-32'>
            <div className='flex flex-col gap-1'>
                <h1 className='text-xl text-[#151886] font-bold'>Хадгалсан бүтээгдэхүүн </h1>
                    ...
                    <div className='flex gap-10'>
                        ...
                        <div className='flex flex-col justify-between my-4'>
                            ...
                            <div className='flex items-center gap-5'>
                                <button className='p-2 bg-[#FB2E86] px-4 rounded font-semibold text-white'>Худалдан авах</button>
                                <button className='p-2 bg-[#F6F5FF] px-4 rounded font-semibold text-[#535399]'>Хасах</button>
                            </div>
                        </div>
                    </div>
                )
